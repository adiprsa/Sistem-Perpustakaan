		...
		?>
          <table border='0' width='100%'>
			...
			<tr>
				<td>No HP</td>
				<td>
					<input placeholder='Nomor HP' type='number' name='nohp' value='<?=isset($row->nohp) ? $row->nohp : ''?>' class='form-control'>
				</td>
			</tr>
			<tr>
				<td>Email</td>
				<td>
					<input placeholder='Email' type='text' name='email' value='<?=isset($row->email) ? $row->email : ''?>' class='form-control'>
				</td>
			</tr>
			<tr>
				<td>Status</td>
