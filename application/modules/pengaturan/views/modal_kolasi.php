...
<div class="modal-dialog modal-lg">
		...
		?>
          <table border='0' width='100%'>
			<tr>
				<td>Nama Tipe Kolasi</td>
				<td>
					<input placeholder='Nama tipe kolasi' type='text' name='nama_tipe_kolasi' value='<?=isset($row->nama_tipe_kolasi) ? $row->nama_tipe_kolasi : ''?>' class='form-control'>
				</td>
			</tr>
		  </table>
        </div>
