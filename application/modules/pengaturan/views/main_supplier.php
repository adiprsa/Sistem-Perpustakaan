	...
	$(document).ready(function() {
	   table = $('#example').DataTable({
		...
		// Load data for the table's content from an Ajax source
			"ajax": {
			"url": "<?=site_url('Pengaturan/supplier_list')?>",
			"type": "POST",
		},
...
<script>
	$(document).on('click','.ganti',function(){
					$('#tampil_form').load("<?=site_url()?>Pengaturan/modal_form_supplier/"+ $(this).attr('id'),function(){
					$('#modal_form').modal('show');
					});
				});
	$(document).on('click','.tambah',function(){
					$('#tampil_form').load("<?=site_url()?>Pengaturan/modal_form_supplier/",function(){
					$('#modal_form').modal('show');
					});
				});
	$(document).on('click','.hapus',function(){
		...
		if (cnf == true) {
			//alert ($(this).attr('id'));
			location.href = '<?=site_url()?>Pengaturan/hapus_supplier/' + $(this).attr('id');
		}
	});
