	...
	$(document).ready(function() {
	   table = $('#example').DataTable({
		...
		// Load data for the table's content from an Ajax source
			"ajax": {
			"url": "<?=site_url('pengaturan/bahasa/bahasa_list')?>",
			"type": "POST",
		},
...
<script>
	$(document).on('click','.ganti',function(){
					$('#tampil_form').load("<?=site_url()?>pengaturan/bahasa/modal_form_bahasa/"+ $(this).attr('id'),function(){
					$('#modal_form').modal('show');
					});
				});
	$(document).on('click','.tambah',function(){
					$('#tampil_form').load("<?=site_url()?>pengaturan/bahasa/modal_form_bahasa/",function(){
					$('#modal_form').modal('show');
					});
				});
	$(document).on('click','.hapus',function(){
		...
		if (cnf == true) {
			//alert ($(this).attr('id'));
			location.href = '<?=site_url()?>pengaturan/bahasa/hapus_bahasa/' + $(this).attr('id');
		}
	});
	$(document).on('click','.import',function(){
		$('#tampil_form').load("<?=site_url()?>pengaturan/bahasa/modal_import_bahasa/",function(){
		$('#modal_form').modal('show');
		});
	});
