	...
	$(document).ready(function() {
	   table = $('#example').DataTable({
		...
		// Load data for the table's content from an Ajax source
			"ajax": {
			"url": "<?=site_url('pengaturan/frekuensi/frekuensi_list')?>",
			"type": "POST",
		},
...
<script>
	$(document).on('click','.ganti',function(){
					$('#tampil_form').load("<?=site_url()?>pengaturan/frekuensi/modal_form_frekuensi/"+ $(this).attr('id'),function(){
					$('#modal_form').modal('show');
					});
				});
	$(document).on('click','.tambah',function(){
					$('#tampil_form').load("<?=site_url()?>pengaturan/frekuensi/modal_form_frekuensi/",function(){
					$('#modal_form').modal('show');
					});
				});
	$(document).on('click','.hapus',function(){
		var cnf = confirm("Apakah anda yakin akan menghapus frekuensi ini?");
		if (cnf == true) {
			//alert ($(this).attr('id'));
			location.href = '<?=site_url()?>pengaturan/frekuensi/hapus_frekuensi/' + $(this).attr('id');
		}
	});
