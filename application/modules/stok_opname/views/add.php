            ...
            <div class="card-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-6 col-lg-10">
                  <input id="tgl_mulai" type="text" name="tgl_mulai" data-parsley-type="tgl_mulai" placeholder="YYYY-MM-DD" class="form-control" required>
                </div>
              </div>
              <div class="form-group row">
                <label for="tgl_mulai" class="col-3 col-lg-2 col-form-label text-right">Tanggal Selesai</label>
                <div class="col-6 col-lg-10">
                  <input id="tgl_selesai" type="text" name="tgl_selesai" data-parsley-type="tgl_selesai" placeholder="YYYY-MM-DD" class="form-control" required>
                </div>
              </div>
              <div class="form-group row">
