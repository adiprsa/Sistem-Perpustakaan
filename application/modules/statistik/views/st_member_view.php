            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="page-header">
                        <h2 class="pageheader-title">Statistik Daftar Anggota Perpustakaan</h2>
                        <div class="page-breadcrumb">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Statistik</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Statistik Daftar Anggota Perpustakaan</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <form method="POST" action="tampil_statistik_member">
                                    <div class="form-row">
                                        ...
                                        <div class="col-xl-2 col-lg-4 col-md-12 col-sm-12 col-12 mb-2">
                                            <select name="type" class="form-control">
                                                <option name="" disabled selected>Type</option>
                            ...
                            <script>
                                ...
                                function showGraph() {
                                    var data = <?php echo json_encode($member); ?>;
                                    var list_month = [];
                                    var list_tipe = [];
                                    var data_sets = []
                                    var data_member = {}
                                    ...
                                    for (var i in data) {
                                        ...
                                        list_tipe.push(data[i].tipe);
                                    }
                                    var month_list = list_month.filter(unique);
                                    var tipe_list = list_tipe.filter(unique);

                                    for (var i in tipe_list) {
                                        data_member[i] = [];
                                        for (var j in month_list) {
                                            var data_mb = "0";
                                            for (var k in data) {
                                                if (data[k].month == month_list[j] && data[k].tipe == tipe_list[i]) {
                                                    data_mb = data[k].tot_member;
                                                }
                                            }
                                            data_member[i].push(data_mb);
                                        }
                                        data_sets.push({
                                            label: tipe_list[i],
