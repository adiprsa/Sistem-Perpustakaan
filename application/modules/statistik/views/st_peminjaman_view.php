            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="page-header">
                        <h2 class="pageheader-title">Statistik Peminjaman Buku</h2>
                        <div class="page-breadcrumb">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Statistik</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Statistik Peminjaman Buku</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <form method="POST" action="tampil_statistik_peminjaman">
                                    <div class="form-row">
                            ...
                            <script>
                                ...
                                function showGraph() {
                                    var data = <?php echo json_encode($peminjaman); ?>;
                                    var list_month = [];
                                    var list_jenis = [];
                                    var data_sets = []
                                    var data_pinjam = {}
